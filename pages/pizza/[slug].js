            ...
            <span> <span style={{color:"var(--themeRed)"}}>$</span> {pizza.price[Size]}</span>
                ...
                <div className={css.quantity}>
                    ...
                    <div className={css.counter}>
                        <Image src={LeftArrow} alt="" height={20} width={20} objectFit="contain" onClick={()=>handleQuanty("dec")} />

                        <span>{Quantity}</span>

                        <Image src={RightArrow} alt="" height={20} width={20} objectFit="contain" onClick={()=>handleQuanty("inc")} />
                    </div>
                </div>
